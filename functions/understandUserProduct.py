...
def understandUserProduct():
  
  most_recent_image = find_most_recent_file("product_pictures/product_pictures_raw")
  ...
  messages=[
      ...
      "content": [
          ...
          {"type": "text", "text": "La imagen adjunta es el producto del usuario. Analiza la imagen y describe el producto. Asimismo, resalta características del producto con uso potencial mercadológico."},
          {
          "type": "image_url",
          "image_url": {
