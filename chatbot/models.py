...
class Chat(models.Model):
    ...
    image_path = models.ImageField(null=True, blank=True, upload_to="django_chatbot/core_functions_mars/functions/saved_images")
    user_input_image = models.ImageField(null=True, blank=True, upload_to="django_chatbot/core_functions_mars/functions/downloaded_images")
